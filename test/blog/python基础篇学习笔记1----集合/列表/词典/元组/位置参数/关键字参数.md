# python 3.5基础篇学习笔记1----列表/元组/词典/集合/函数(位置参数/关键字参数/可变参数)
## 列表----任意类型元素组成的序列,列表可变,用[]表示
## 元组----元组不可变,用()表示
## 词典----{key:value}
## 集合----仅剩下键的词典
...
# code---- https://github.com/undergrowthlinear/learn_python/blob/master/test/blog_test/python_learnnote1.py
```
# encoding=utf-8
